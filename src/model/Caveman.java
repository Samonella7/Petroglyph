 ...
 * 
 * Cavemen are controlled by players. They can move only in Participant.Directions, not in diagonals. Each Caveman is
 * associated with a Spear, which it can throw and then pick up again any number of times. A caveman can be knocked out
 * by touching the Mammoth, and can be picked up again by contact with another (conscious) Caveman.
 * 
...
public class Caveman extends Participant {
	...
	/**
	 * Creates a caveman (and its associated spear) at the given location, and of the given color.
	 */
	...
	/**
	 * Updates this caveman's location for the next frame. If this Caveman is hold its spear, the update's the spear's
	 * location as well.
	 */
	@Override
	public void move() {
	...
	/**
	 * If this spear is held by its (conscious) associated caveman, throw this spear. Does nothing otherwise.
	 */
